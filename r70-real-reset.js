...
function migrateSep26(){
 ...
 const a=db.accounts.find(x=>x.id===aid);if(a){a.balance=620.62;a.openingBalance=620.62;a.balanceDate='2026-09-20';a.statementVerified=true}

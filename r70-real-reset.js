...
function migrateSep26(){
 ...
 const confirmed=[
  ...
  ['c6_2026_09_20_pix_andress_8000','2026-09-20','PIX enviado para Andress Raquel de Almeida',-80.00,'Outros','PIX enviado'],
  ['c6_2026_09_20_pix_sympla_6630','2026-09-20','PIX enviado para Sympla Internet Soluções S/A',-66.30,'Outros','PIX enviado']
 ];
 confirmed.forEach(([id,date,desc,value,cat,sub])=>{if(!db.transactions.some(t=>String(t.id)===id))db.transactions.push({id,date,desc,description:desc,value,cat,sub,status:'realized',origin:'Extrato C6 confirmado',source:'Extrato C6 confirmado',account:aid,accountId:aid,paymentMethod:id.includes('_pix_')?'PIX':'Débito',statementVerified:true,classificationPending:id==='c6_2026_09_20_pix_andress_8000'||id==='c6_2026_09_20_pix_sympla_6630'})});
 ...
 db.meta.c6Sep2026Validated=version;db.meta.statementInReported=2639.62;db.meta.statementOutReported=2174.72;db.meta.statementOutVisible=2174.72;db.meta.statementDifference=0;db.meta.realBase='R10.15';

...
build=()=>{const next=legacyBuild(),c6=next.accounts.find(a=>a.id==='acc_c6'),caju=next.cards.find(c=>c.id==='card_caju_alimentacao');if(c6){c6.balance=486.31;c6.openingBalance=21.41;c6.balanceDate='2026-09-20'}if(caju){caju.availableLimit=525.17;caju.balance=525.17}return next};

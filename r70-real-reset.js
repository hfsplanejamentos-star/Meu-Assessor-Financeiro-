...
function migrateSep26(){
 ...
 const a=db.accounts.find(x=>x.id===aid);if(a){a.balance=897.87;a.openingBalance=897.87;a.balanceDate='2026-09-19';a.statementVerified=true}
 db.meta.c6Sep2026Validated=version;db.meta.statementInReported=2639.62;db.meta.statementOutReported=1751.17;db.meta.realBase='R10.13';

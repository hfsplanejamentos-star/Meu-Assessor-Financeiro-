...
const baseline={
 ...
 recurring:[
  recurring('rec_pensao','Pensão','Pensão',-1500,'2026-10-10','2027-07-10',10),recurring('rec_carro','Prestação do carro','C4 Cactus',-1000,'2026-10-10','2027-07-10',10),recurring('rec_aluguel','Aluguel','Moradia',-1250,'2026-10-10','2027-07-10',10),recurring('rec_internet','Internet','Moradia',-80,'2026-10-10','2027-07-10',10),recurring('rec_tim','Plano TIM','Plano TIM',-79.90,'2026-10-10','2027-07-10',10),recurring('rec_luz','Conta de Luz','Moradia',-150,'2026-10-10','2027-07-10',10),recurring('rec_emp_mae','Móveis','Móveis',-300,'2026-10-10','2027-05-10',10,{installments:8})
 ],
 transactions:[

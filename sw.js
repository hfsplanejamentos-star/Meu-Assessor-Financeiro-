const CACHE = 'assessor-v10-production-10.0.1';
const ASSETS = [
  ...
  './v10/month-sync.js', './v10/runtime-ui.js', './v10/experience.js', './v10/financial-cards.css',
  './v10/financial-cards.js', './v10/finance-tests.js',
